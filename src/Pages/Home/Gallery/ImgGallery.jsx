...
const ImgGallery = () => {
  return (
    <div className="my-5">
    <h1 className="text-center font-bold text-3xl  my-9">Cars Gallery</h1>
      <Tabs>
        <div className="bg-white place-item-center">
        ...
        <TabPanel>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="lg:h-[400px]">
              <img src={car1} alt="Toy 1" className="w-full h-full mb-2 rounded-md" />
            </div>
            ...
            <div className="border border-gray-300 rounded-md p-4">
            <div className="lg:h-[400px]">
              <img src={car2} alt="Toy 1" className="w-full h-full mb-2 rounded-md" />
            </div>
        ...
        <TabPanel>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-gray-300 rounded-md p-4">
            <div className="lg:h-[400px]">
              <img src={truck1} alt="Toy 1" className="w-full h-full mb-2 rounded-md" />
            </div>
            ...
            <div className="border border-gray-300 rounded-md p-4">
            <div className="lg:h-[400px]">
              <img src={truck2} alt="Toy 1" className="w-full h-full mb-2 rounded-md" />
            </div>
        ...
        <TabPanel>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-gray-300 rounded-md p-4">
              <div className="lg:h-[400px]">
              <img src={RC1} alt="Toy 1" className="w-full h-full mb-2 rounded-md" />
            </div>
            ...
            <div className="border border-gray-300 rounded-md p-4">
            <div className="lg:h-[400px]">
              <img src={RC2} alt="Toy 1" className="w-full h-full mb-2 rounded-md" />
            </div>
        ...
        <TabPanel>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-gray-300 rounded-md p-4">
              <div className="lg:h-[400px]">
              <img src={MF1} alt="Toy 1" className="w-full h-full mb-2 rounded-md" />
            </div>
            ...
            <div className="border border-gray-300 rounded-md p-4">
            <div className="lg:h-[400px]">
              <img src={MF2} alt="Toy 1" className="w-full h-full mb-2 rounded-md" />
            </div>
        ...
        <TabPanel>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="border border-gray-300 rounded-md p-4">
              <div className="lg:h-[400px]">
              <img src={PC1} alt="Toy 1" className="w-full h-full mb-2 rounded-md" />
            </div>
            ...
            <div className="border border-gray-300 rounded-md p-4">
            <div className="lg:h-[400px]">
              <img src={PC2} alt="Toy 1" className="w-full h-full mb-2 rounded-md" />
            </div>
